...
class App(QMainWindow):
    ...
    def initUI(self):
        self.setWindowTitle("LaTeXGen")
        QApplication.setWindowIcon(QtGui.QIcon('.\deployment\gui\icons\gui_icon_1.png'))
        self.left = 300
        self.top = 300
        self.width = 500
        self.height = 300
    ...
    def displayPrediction(self, prediction=None):
        if self.isProcessing:
            ...
            <html>
            <head>
            <script id="MathJax-script" src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.7/MathJax.js?config=TeX-MML-AM_CHTML"></script>
            <script>
