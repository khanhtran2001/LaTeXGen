...
ONNX_MODEL_DIR = Path(__file__).resolve().parents[1] / "onnx_model"
TOKENIZER_PATH = ONNX_MODEL_DIR / "tokenizer.json"
ENCODER_MODEL = ONNX_MODEL_DIR / "encoder_model.onnx"
DECODER_MODEL = ONNX_MODEL_DIR / "decoder_model.onnx"
